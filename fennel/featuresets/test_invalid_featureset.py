...
def test_invalid_featureset():
    with pytest.raises(ValueError) as e:
        ...
        class UserInfo:
            extractors: List[int]
            home_geoid: int
            age: int = feature().meta(deprecated=True)
            credit_score: int
...
class UserInfo2:
    user_id: int
    home_geoid: int
    age: int = feature(UserInfoDataset.age, default=0)  # type: ignore
    credit_score: int
...
def test_invalid_autogenerated_extractors(client):
    with pytest.raises(TypeError) as e:
        ...
        class UserInfo:
            user_id: int
            home_geoid: int
            age: int = feature(UserInfoDataset.age)
            credit_score: int
    ...
    with pytest.raises(TypeError) as e:
        ...
        class UserInfo1:
            user_id: int
            home_geoid: int
            age: float = feature(UserInfoDataset.age, default=0)
            credit_score: int
    ...
    with pytest.raises(TypeError) as e:
        ...
        class UserInfo2:
            user_id: int
            home_geoid: float = feature(UserInfo2.home_geoid)
            age: int
            credit_score: int
    ...
    with pytest.raises(ValueError) as e:
        ...
        class UserInfo3:
            user_id: int
            home_geoid: int
            age: int = feature(UserInfoDataset.age, default=0.0)
            credit_score: int
    ...
    with pytest.raises(ValueError) as e:
        ...
        class UserInfo4:
            user_id: int
            home_geoid: int
            country: str = feature(UserInfoDataset.country, default=0.0)
            credit_score: int
...
def test_invalid_alias_feature(client):
    ...
    with pytest.raises(TypeError) as e:
        ...
        @featureset
        class B:
            user_id: int = feature(A.user_id, default=0)
            home_geoid: int
            credit_score: int
