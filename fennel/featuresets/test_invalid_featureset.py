...
def test_invalid_autogenerated_extractors(client):
    with pytest.raises(TypeError) as e:
        ...
        class UserInfo:
            user_id: int = F()
            home_geoid: int = F()
            age: int = F(ref=UserInfoDataset.age)
            credit_score: int = F()
    ...
    with pytest.raises(TypeError) as e:
        ...
        class UserInfo1:
            user_id: int = F()
            home_geoid: int = F()
            age: float = F(ref=UserInfoDataset.age, default=0)
            credit_score: int = F()
    ...
    with pytest.raises(TypeError) as e:
        ...
        class UserInfo2:
            user_id: int = F()
            home_geoid: float = F(ref=UserInfo2.home_geoid)
            age: int = F()
            credit_score: int = F()
    ...
    with pytest.raises(ValueError) as e:
        ...
        class UserInfo3:
            user_id: int = F()
            home_geoid: int = F()
            age: int = F(ref=UserInfoDataset.age, default=0.0)
            credit_score: int = F()
    ...
    with pytest.raises(ValueError) as e:
        ...
        class UserInfo4:
            user_id: int = F()
            home_geoid: int = F()
            country: str = F(ref=UserInfoDataset.country, default=0.0)
            credit_score: int = F()
