...
def _get_parsing_type(type_: Any, *,
                      type_name: Optional[NameFactory] = None) -> Any:
    from fennel._vendor.pydantic.main import create_model
...
def parse_obj_as(type_: Type[T], obj: Any, *,
                 type_name: Optional[NameFactory] = None) -> T:
    model_type = _get_parsing_type(type_,
...
def schema_of(type_: Any, *, title: Optional[NameFactory] = None,
    ...
    return _get_parsing_type(type_, type_name=title).new_schema(**schema_kwargs)
