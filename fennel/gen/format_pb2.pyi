...
class FileFormat(google.protobuf.message.Message):
    ...
    @property
    def pandas(self) -> global___FileFormat.Pandas: ...
    def __init__(
        self,
        *,
        ...
        pandas: global___FileFormat.Pandas | None = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["avro", b"avro", "csv", b"csv", "delta_table", b"delta_table", "hudi", b"hudi", "json", b"json", "kind", b"kind", "pandas", b"pandas", "parquet", b"parquet"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["avro", b"avro", "csv", b"csv", "delta_table", b"delta_table", "hudi", b"hudi", "json", b"json", "kind", b"kind", "pandas", b"pandas", "parquet", b"parquet"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["kind", b"kind"]) -> typing_extensions.Literal["parquet", "json", "avro", "hudi", "delta_table", "csv", "pandas"] | None: ...
