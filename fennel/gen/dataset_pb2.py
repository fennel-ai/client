...
_JOIN_ONENTRY = _JOIN.nested_types_by_name['OnEntry']
_TRANSFORM = DESCRIPTOR.message_types_by_name['Transform']
_TRANSFORM_SCHEMAENTRY = _TRANSFORM.nested_types_by_name['SchemaEntry']
...
_RENAME_COLUMNMAPENTRY = _RENAME.nested_types_by_name['ColumnMapEntry']
_UNION = DESCRIPTOR.message_types_by_name['Union']
_DEDUP = DESCRIPTOR.message_types_by_name['Dedup']
_EXPLODE = DESCRIPTOR.message_types_by_name['Explode']
_FIRST = DESCRIPTOR.message_types_by_name['First']
_DATASETREF = DESCRIPTOR.message_types_by_name['DatasetRef']
_DATAFLOW = DESCRIPTOR.message_types_by_name['Dataflow']
_DATAFLOW_PIPELINEDATAFLOW = _DATAFLOW.nested_types_by_name['PipelineDataflow']
_PIPELINELINEAGES = DESCRIPTOR.message_types_by_name['PipelineLineages']
_DATASETPIPELINELINEAGES = DESCRIPTOR.message_types_by_name['DatasetPipelineLineages']
_DATASETLINEAGES = DESCRIPTOR.message_types_by_name['DatasetLineages']
_JOIN_HOW = _JOIN.enum_types_by_name['How']
CoreDataset = _reflection.GeneratedProtocolMessageType('CoreDataset', (_message.Message,), {

  'FieldMetadataEntry' : _reflection.GeneratedProtocolMessageType('FieldMetadataEntry', (_message.Message,), {
    'DESCRIPTOR' : _COREDATASET_FIELDMETADATAENTRY,
    '__module__' : 'dataset_pb2'
    # @@protoc_insertion_point(class_scope:fennel.proto.dataset.CoreDataset.FieldMetadataEntry)
    })
  ,
  'DESCRIPTOR' : _COREDATASET,
  '__module__' : 'dataset_pb2'
  # @@protoc_insertion_point(class_scope:fennel.proto.dataset.CoreDataset)
  })
_sym_db.RegisterMessage(CoreDataset)
_sym_db.RegisterMessage(CoreDataset.FieldMetadataEntry)

OnDemand = _reflection.GeneratedProtocolMessageType('OnDemand', (_message.Message,), {
  'DESCRIPTOR' : _ONDEMAND,
  '__module__' : 'dataset_pb2'
  # @@protoc_insertion_point(class_scope:fennel.proto.dataset.OnDemand)
  })
...
Pipeline = _reflection.GeneratedProtocolMessageType('Pipeline', (_message.Message,), {
  ...
  '__module__' : 'dataset_pb2'
  # @@protoc_insertion_point(class_scope:fennel.proto.dataset.Pipeline)
  })
...
Operator = _reflection.GeneratedProtocolMessageType('Operator', (_message.Message,), {
  ...
  '__module__' : 'dataset_pb2'
  # @@protoc_insertion_point(class_scope:fennel.proto.dataset.Operator)
  })
...
Aggregate = _reflection.GeneratedProtocolMessageType('Aggregate', (_message.Message,), {
  ...
  '__module__' : 'dataset_pb2'
  # @@protoc_insertion_point(class_scope:fennel.proto.dataset.Aggregate)
  })
_sym_db.RegisterMessage(Aggregate)

Join = _reflection.GeneratedProtocolMessageType('Join', (_message.Message,), {

  'OnEntry' : _reflection.GeneratedProtocolMessageType('OnEntry', (_message.Message,), {
    'DESCRIPTOR' : _JOIN_ONENTRY,
    '__module__' : 'dataset_pb2'
    # @@protoc_insertion_point(class_scope:fennel.proto.dataset.Join.OnEntry)
    })
  ,
  'DESCRIPTOR' : _JOIN,
  '__module__' : 'dataset_pb2'
  # @@protoc_insertion_point(class_scope:fennel.proto.dataset.Join)
  })
_sym_db.RegisterMessage(Join)
_sym_db.RegisterMessage(Join.OnEntry)
...
Transform = _reflection.GeneratedProtocolMessageType('Transform', (_message.Message,), {
  ...
  'SchemaEntry' : _reflection.GeneratedProtocolMessageType('SchemaEntry', (_message.Message,), {
    'DESCRIPTOR' : _TRANSFORM_SCHEMAENTRY,
    '__module__' : 'dataset_pb2'
    # @@protoc_insertion_point(class_scope:fennel.proto.dataset.Transform.SchemaEntry)
    })
  ,
  'DESCRIPTOR' : _TRANSFORM,
  '__module__' : 'dataset_pb2'
  # @@protoc_insertion_point(class_scope:fennel.proto.dataset.Transform)
  })
_sym_db.RegisterMessage(Transform)
_sym_db.RegisterMessage(Transform.SchemaEntry)

Filter = _reflection.GeneratedProtocolMessageType('Filter', (_message.Message,), {
  'DESCRIPTOR' : _FILTER,
  '__module__' : 'dataset_pb2'
  # @@protoc_insertion_point(class_scope:fennel.proto.dataset.Filter)
  })
_sym_db.RegisterMessage(Filter)

Drop = _reflection.GeneratedProtocolMessageType('Drop', (_message.Message,), {
  'DESCRIPTOR' : _DROP,
  '__module__' : 'dataset_pb2'
  # @@protoc_insertion_point(class_scope:fennel.proto.dataset.Drop)
  })
...
Rename = _reflection.GeneratedProtocolMessageType('Rename', (_message.Message,), {
  ...
  'ColumnMapEntry' : _reflection.GeneratedProtocolMessageType('ColumnMapEntry', (_message.Message,), {
    'DESCRIPTOR' : _RENAME_COLUMNMAPENTRY,
    '__module__' : 'dataset_pb2'
    # @@protoc_insertion_point(class_scope:fennel.proto.dataset.Rename.ColumnMapEntry)
    })
  ,
  'DESCRIPTOR' : _RENAME,
  '__module__' : 'dataset_pb2'
  # @@protoc_insertion_point(class_scope:fennel.proto.dataset.Rename)
  })
_sym_db.RegisterMessage(Rename)
_sym_db.RegisterMessage(Rename.ColumnMapEntry)

Union = _reflection.GeneratedProtocolMessageType('Union', (_message.Message,), {
  'DESCRIPTOR' : _UNION,
  '__module__' : 'dataset_pb2'
  # @@protoc_insertion_point(class_scope:fennel.proto.dataset.Union)
  })
_sym_db.RegisterMessage(Union)

Dedup = _reflection.GeneratedProtocolMessageType('Dedup', (_message.Message,), {
  'DESCRIPTOR' : _DEDUP,
  '__module__' : 'dataset_pb2'
  # @@protoc_insertion_point(class_scope:fennel.proto.dataset.Dedup)
  })
_sym_db.RegisterMessage(Dedup)

Explode = _reflection.GeneratedProtocolMessageType('Explode', (_message.Message,), {
  'DESCRIPTOR' : _EXPLODE,
  '__module__' : 'dataset_pb2'
  # @@protoc_insertion_point(class_scope:fennel.proto.dataset.Explode)
  })
_sym_db.RegisterMessage(Explode)

First = _reflection.GeneratedProtocolMessageType('First', (_message.Message,), {
  'DESCRIPTOR' : _FIRST,
  '__module__' : 'dataset_pb2'
  # @@protoc_insertion_point(class_scope:fennel.proto.dataset.First)
  })
...
DatasetRef = _reflection.GeneratedProtocolMessageType('DatasetRef', (_message.Message,), {
  ...
  '__module__' : 'dataset_pb2'
  # @@protoc_insertion_point(class_scope:fennel.proto.dataset.DatasetRef)
  })
_sym_db.RegisterMessage(DatasetRef)

Dataflow = _reflection.GeneratedProtocolMessageType('Dataflow', (_message.Message,), {

  'PipelineDataflow' : _reflection.GeneratedProtocolMessageType('PipelineDataflow', (_message.Message,), {
    'DESCRIPTOR' : _DATAFLOW_PIPELINEDATAFLOW,
    '__module__' : 'dataset_pb2'
    # @@protoc_insertion_point(class_scope:fennel.proto.dataset.Dataflow.PipelineDataflow)
    })
  ,
  'DESCRIPTOR' : _DATAFLOW,
  '__module__' : 'dataset_pb2'
  # @@protoc_insertion_point(class_scope:fennel.proto.dataset.Dataflow)
  })
_sym_db.RegisterMessage(Dataflow)
_sym_db.RegisterMessage(Dataflow.PipelineDataflow)

PipelineLineages = _reflection.GeneratedProtocolMessageType('PipelineLineages', (_message.Message,), {
  'DESCRIPTOR' : _PIPELINELINEAGES,
  '__module__' : 'dataset_pb2'
  # @@protoc_insertion_point(class_scope:fennel.proto.dataset.PipelineLineages)
  })
_sym_db.RegisterMessage(PipelineLineages)

DatasetPipelineLineages = _reflection.GeneratedProtocolMessageType('DatasetPipelineLineages', (_message.Message,), {
  'DESCRIPTOR' : _DATASETPIPELINELINEAGES,
  '__module__' : 'dataset_pb2'
  # @@protoc_insertion_point(class_scope:fennel.proto.dataset.DatasetPipelineLineages)
  })
_sym_db.RegisterMessage(DatasetPipelineLineages)

DatasetLineages = _reflection.GeneratedProtocolMessageType('DatasetLineages', (_message.Message,), {
  'DESCRIPTOR' : _DATASETLINEAGES,
  '__module__' : 'dataset_pb2'
  # @@protoc_insertion_point(class_scope:fennel.proto.dataset.DatasetLineages)
  })
_sym_db.RegisterMessage(DatasetLineages)
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _OPERATOR._serialized_end=1709
  _AGGREGATE._serialized_start=1711
  _AGGREGATE._serialized_end=1821
  _JOIN._serialized_start=1824
  _JOIN._serialized_end=2242
  _JOIN_ONENTRY._serialized_start=2142
  _JOIN_ONENTRY._serialized_end=2183
  _JOIN_HOW._serialized_start=2185
  _JOIN_HOW._serialized_end=2211
  _TRANSFORM._serialized_start=2245
  _TRANSFORM._serialized_end=2482
  _TRANSFORM_SCHEMAENTRY._serialized_start=2406
  _TRANSFORM_SCHEMAENTRY._serialized_end=2482
  _FILTER._serialized_start=2484
  _FILTER._serialized_end=2579
  _DROP._serialized_start=2581
  _DROP._serialized_end=2647
  _RENAME._serialized_start=2650
  _RENAME._serialized_end=2815
  _RENAME_COLUMNMAPENTRY._serialized_start=2767
  _RENAME_COLUMNMAPENTRY._serialized_end=2815
  _UNION._serialized_start=2817
  _UNION._serialized_end=2868
  _DEDUP._serialized_start=2870
  _DEDUP._serialized_end=2936
  _EXPLODE._serialized_start=2938
  _EXPLODE._serialized_end=3006
  _FIRST._serialized_start=3008
  _FIRST._serialized_end=3069
  _DATASETREF._serialized_start=3071
  _DATASETREF._serialized_end=3115
  _DATAFLOW._serialized_start=3118
  _DATAFLOW._serialized_end=3360
  _DATAFLOW_PIPELINEDATAFLOW._serialized_start=3232
  _DATAFLOW_PIPELINEDATAFLOW._serialized_end=3352
  _PIPELINELINEAGES._serialized_start=3363
  _PIPELINELINEAGES._serialized_end=3505
  _DATASETPIPELINELINEAGES._serialized_start=3507
  _DATASETPIPELINELINEAGES._serialized_end=3599
  _DATASETLINEAGES._serialized_start=3601
  _DATASETLINEAGES._serialized_end=3726
