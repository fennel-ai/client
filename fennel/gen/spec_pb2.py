...
_DISTINCT = DESCRIPTOR.message_types_by_name['Distinct']
...
Distinct = _reflection.GeneratedProtocolMessageType('Distinct', (_message.Message,), {
  'DESCRIPTOR' : _DISTINCT,
  '__module__' : 'spec_pb2'
  # @@protoc_insertion_point(class_scope:fennel.proto.spec.Distinct)
  })
_sym_db.RegisterMessage(Distinct)
