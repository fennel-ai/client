...
_EXPECTATIONS = DESCRIPTOR.message_types_by_name['Expectations']
_EXPECTATION = DESCRIPTOR.message_types_by_name['Expectation']
_EXPECTATIONS_ENTITYTYPE = _EXPECTATIONS.enum_types_by_name['EntityType']
Expectations = _reflection.GeneratedProtocolMessageType('Expectations', (_message.Message,), {
  'DESCRIPTOR' : _EXPECTATIONS,
  '__module__' : 'expectations_pb2'
  # @@protoc_insertion_point(class_scope:fennel.proto.expectations.Expectations)
  })
_sym_db.RegisterMessage(Expectations)

Expectation = _reflection.GeneratedProtocolMessageType('Expectation', (_message.Message,), {
  'DESCRIPTOR' : _EXPECTATION,
  '__module__' : 'expectations_pb2'
  # @@protoc_insertion_point(class_scope:fennel.proto.expectations.Expectation)
  })
