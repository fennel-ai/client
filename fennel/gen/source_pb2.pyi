...
class DataConnector(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["bigquery", b"bigquery", "every", b"every", "name", b"name", "s3", b"s3", "snowflake", b"snowflake", "source", b"source", "sql", b"sql"]) -> None: ...
...
class S3(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["aws_access_key_id", b"aws_access_key_id", "aws_secret_access_key", b"aws_secret_access_key", "bucket", b"bucket", "delimiter", b"delimiter", "format", b"format", "path_prefix", b"path_prefix", "schema", b"schema"]) -> None: ...
