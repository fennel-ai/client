...
class TestLatestSnips(unittest.TestCase):
    @mock
    def test_basic(self, client):
        ...
        class LatestOnly:
            ...
            @pipeline
            @inputs(Transaction)
            def latest_pipeline(cls, ds: Dataset):
                # docsnip-highlight next-line
                return ds.groupby("uid").latest()

        # /docsnip

        client.commit(message="some msg", datasets=[Transaction, LatestOnly])
