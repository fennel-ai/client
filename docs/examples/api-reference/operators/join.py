...
class TestAssignSnips(unittest.TestCase):
    ...
    def test_basic(self, client):
        ...
        class MerchantCategory:
            merchant: int = field(key=True) # won't show up in the joined dataset
            category: str
        ...
        client.log("webhook", "Transaction", pd.DataFrame([
            {"uid": 1, "merchant": 4, "amount": 10, "timestamp": "2021-01-01T00:00:00"},
            {"uid": 2, "merchant": 5, "amount": 20, "timestamp": "2021-01-01T00:00:00"},
            {"uid": 3, "merchant": 4, "amount": 30, "timestamp": "2021-01-01T00:00:00"},
            {"uid": 3, "merchant": 6, "amount": 30, "timestamp": "2021-01-01T00:00:00"},
        ]))
        client.log("webhook", "MerchantCategory", pd.DataFrame([
            {"merchant": 4, "category": "grocery", "updated_at": "2021-01-01T00:00:00"},
            {"merchant": 5, "category": "electronics", "updated_at": "2021-01-01T00:00:00"},
        ]))
